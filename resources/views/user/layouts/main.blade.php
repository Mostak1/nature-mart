...
<head>
    ...
    <title>@yield('title', 'Nature-Mart')</title>
...
<body>
    ...
    <div class="humberger__menu__wrapper">
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> naturemartbd@gmail.com</li>
                <li>Free Shipping for all Order of </li>
            </ul>
        </div>
    </div>
    <!-- Humberger End -->
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        ...
                        <ul>
                            <li>Islam Tower, Shukrabad Bus Stand, Dhaka, Bangladesh</li>
                            <li>Phone: +8809666-747470</li>
                            <li>Email: naturemartbd@gmail.com</li>
                        </ul>
                    </div>
                </div>
                        ...
                        <div class="footer__copyright__text">
                            <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                                ...
                                <script>
                                    ...
                                    class="fa fa-heart" aria-hidden="true"></i> by <a href="https://mostaksarker.com/"
                                    target="_blank">Nature Mart</a>
